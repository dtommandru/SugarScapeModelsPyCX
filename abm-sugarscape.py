...
def initialize():
    ...
    for ag in agents:
        ...
        ag.metabolism = random.randint(5, 10)
        ag.sugar = random.randint(10,30)
        ag.vision = random.randint(1,6)
        ap = None
    ...
    for x in range(x_lim):
        for y in range(y_lim):
            ...
            if x <= 24 and y <= 24:
                ...
                sugar[-1].max_capacity = sugar[-1].available_sugar+10
...
def observe():
    ...
    plot(acount, label = 'Agents Alive',color='green')
    xlabel("Time")
